...
Last Modified: 2025-03-26 | Code: APICAME

This article explains the process of retrieving information about media, attached to the surveys with "Ok for Client Access" status, using the MediaExplorer Query Resource.
...
The example details how to use the “/APIv2/Query/ClientAnalytics/MediaExplorer” dataset to get the same data as the Client Access -> Media Explorer.
...
Step 4 - execute the dataset. In Rowset 3 you will see the data for the desired attachments:![](assets/img_06.jpg)

### Postman

The content for the “post” parameter in the Body:

{"action":"exec","dataset":{"datasetname":"/Apps/SM/APIv2/Query/ClientAnalytics/MediaExplorer"},"parameters":[{"name":"ClientOrFormIDs","value":"-1001"},{"name":"SurveyInstanceIDs","value":"5001,5002"},{"name":"AttachmentsIDs","value":"100011,100012,100013,100014,100015,100021,100063,100019,100020"}]}![](assets/img_07.jpg)
...
**Shopmetrics CMS UI:**![](assets/img_08.jpg)
